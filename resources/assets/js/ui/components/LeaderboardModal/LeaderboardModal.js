...
export default class LeaderboardModal extends PureComponent {
  ...
  renderPlayers() {
    ...
    return players.map((player, key) => {
      ...
      return (
        <tr className={classes} key={"leaderboard-" + key + playerNickname}>
  ...
  renderWinningPlayerOrTeam() {
    ...
    const winningPhrase = room.state === "ended" ? "wins!" : "in the lead.";
        ...
        return (
          <div className="winning-player">
            <div className="player-name">
              {this.renderFirstPlacePlayerName()} {winningPhrase}
            </div>
          </div>
        );

      case "TeamDeathmatch":
        const winningTeamName = room.redTeamScore > room.blueTeamScore ? "Red" : "Blue";
        ...
        return (
          <div className={classes}>
            <div className="player-name">
              {winningTeamName} Team {winningPhrase}
            </div>
          </div>
        );
    }
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="row" style={{ marginBottom: "15px" }}>
                  <div className="col-xs-5">{this.renderWinningPlayerOrTeam()}</div>
