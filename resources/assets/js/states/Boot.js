...
Boot.prototype = {
  preload: function() {
    ...
    this.game.load.spritesheet(
      ...
      "/sprites/right-arm-and-weapons.png",
      138,
      30
    );
    ...
    this.game.load.atlas(
      "rpgExplosion",
      "/sprites/rpgExplosion.png",
      "/sprites/rpgExplosion.json",
      window.Phaser.Loader.TEXTURE_ATLAS_JSON_HASH
    );
    this.game.load.atlas(
      "ricochet",
      "/sprites/ricochet.png",
      "/sprites/ricochet.json",
      window.Phaser.Loader.TEXTURE_ATLAS_JSON_HASH
    );
    this.game.load.atlas(
      "player-death",
      "/sprites/player-death.png",
      "/sprites/player-death.json",
      window.Phaser.Loader.TEXTURE_ATLAS_JSON_HASH
    );
    ...
    this.game.load.audio(
      "triplekill",
      "/audio/killingSpree/triplekill_ultimate.mp3"
    );
    this.game.load.audio(
      "multikill",
      "/audio/killingSpree/multikill_ultimate.mp3"
    );
    this.game.load.audio(
      "ultrakill",
      "/audio/killingSpree/ultrakill_ultimate.mp3"
    );
    this.game.load.audio(
      "killingspree",
      "/audio/killingSpree/killingspree_ultimate.mp3"
    );
    this.game.load.audio(
      "unstoppable",
      "/audio/killingSpree/unstoppable_ultimate.mp3"
    );
    this.game.load.audio(
      "ludicrouskill",
      "/audio/killingSpree/ludicrouskill_ultimate.mp3"
    );
    this.game.load.audio(
      "rampagekill",
      "/audio/killingSpree/rampage_ultimate.mp3"
    );
    this.game.load.audio(
      "monsterkill",
      "/audio/killingSpree/monsterkill_ultimate.mp3"
    );
