const GameConsts = {
    ...
    EVENTS: [
        ...
        // client -> server
        'LOAD_COMPLETE', // not emitted from client
        'MESSAGE_SEND',
        'MOVE_PLAYER',
        'NEW_PLAYER',
        'PLAYER_ADJUST_SCORE', // not emitted from client
        'PLAYER_FULL_HEALTH',
        'PLAYER_HEALING',
...
GameConsts.EVENT = {}
GameConsts.EVENTS.forEach((eventName, index) => {
    GameConsts.EVENT[eventName] = index
})

console.log('* LOG * GameConsts.EVENT', GameConsts.EVENT);
