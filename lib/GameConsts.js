const GameConsts = {
    ...
    EVENT: {
        ...
        LOAD_GAME: 2,
        MESSAGE_RECEIVED: 10,
        PLAYER_HEALTH_UPDATE: 7,
        PLAYER_KILL_CONFIRMED: 8,
        PLAYER_KILL_LOG: 9,
        UPDATE_PLAYERS: 3,

        // server <-> client
        BULLET_FIRED: 12,
        KICK_PLAYER: 17, // not emitted from client
        PLAYER_DAMAGED: 6,
        PLAYER_RESPAWN: 5,
        REFRESH_ROOM: 11,

        // client -> server
        LOAD_COMPLETE: 21, // not emitted from client
        MESSAGE_SEND: 14,
        MOVE_PLAYER: 4,
        NEW_PLAYER: 1,
        PLAYER_ADJUST_SCORE: 20, // not emitted from client
        PLAYER_FULL_HEALTH: 18,
        PLAYER_HEALING: 19,
        PLAYER_UPDATE_NICKNAME: 16,
        REFRESH_PLAYERS: 15,
    },
    ...
    MAX_QUALITY_SIZE: 950,
    MIN_QUALITY_SIZE: 700,
