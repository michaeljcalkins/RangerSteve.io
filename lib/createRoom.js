...
const getModWithChance = require('./getModWithChance')
...
module.exports = function (data) {
  ...
  const modId = (typeof data.mod !== 'undefined') && GameConsts.MODS[data.mod]
    ? data.mod
    // : _.sample(_.keys(GameConsts.MODS))
    : getModWithChance(_.keys(GameConsts.MODS), GameConsts.CHANCE_OF_GUN_MOD_IN_PERCENT)
